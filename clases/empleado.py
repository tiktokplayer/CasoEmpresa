...
class Empleado(tipo_empleado, roles):
    def __init__(self, id_empleado, nom_empleado, correo, telefono, direccion, rut, fecha_nacimiento, fecha_contrato, salario, id_tipo_empleado, id_roles, password_emp):
